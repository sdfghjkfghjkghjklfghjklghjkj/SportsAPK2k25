...
function TeamLeaderPortal({ teamName }) {
  ...
  const handleSubmit = (e) => {
    ...
    if (teamName === 'teamleader1') {
      if (chessNum < 100 || chessNum > 199) {
        alert('For Team 1, Chess Number must be between 100 and 199.');
        return;
      }
    } else if (teamName === 'teamleader2') {
      if (chessNum < 200 || chessNum > 299) {
        alert('For Team 2, Chess Number must be between 200 and 299.');
        return;
      }
    } else if (teamName === 'teamleader3') {
      if (chessNum < 300 || chessNum > 399) {
        alert('For Team 3, Chess Number must be between 300 and 399.');
        return;
      }
    }
